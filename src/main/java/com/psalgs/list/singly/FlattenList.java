 ...
 *
 * Flattening a Linked List, result should sorted
 */
public class FlattenList {
    ...
    private Node flatten(Node root) {
        ...
        while (root != null) {
            ...
            Node down_node = root.down;

            while (down_node.down != null) {
                down_node = down_node.down;
            }
            down_node.down = root.right;
            root = root.right;
        }
    ...
    public static void main(String args[]) {
        ...
        // Flatten the list not sort
        L.head = L.flatten_sort(L.head);
        L.printList();
    }
}
