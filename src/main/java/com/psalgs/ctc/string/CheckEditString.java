...
public class CheckEditString {
    ...
    public static void main(String args[]) {
        CheckEditString one = new CheckEditString();

        System.out.println(one.oneEditAway("pale", "ple"));
        System.out.println(one.oneEditAway("pales", "pale"));
        System.out.println(one.oneEditAway("pale", "bale"));
