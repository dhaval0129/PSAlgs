 ...
 * @author djoshi
 *
 * http://www.geeksforgeeks.org/matrix-multiplication-recursive/
 *
 * Matrix Multiplication | Recursive
 *
 */
public class MatrixMultiplyRec {
    ...
    private static void multiplyMatrixRec(int row1, int col1, int A[][],
    ...
    private static void multiplyMatrix(int row1, int col1, int A[][],
